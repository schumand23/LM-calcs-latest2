...
//    }
    ...
    func calculateFusedPitchAndRoll() -> (pitch: Double, roll: Double, frontHeight: Double, sideHeight: Double) {
        ...
        print("(calculateFusedPitchAndRoll) Accelerometer Roll: \(accelerometerData.roll)")
        print("(calculateFusedPitchAndRoll) Gyroscope Roll: \(gyroscopeData.roll)")
        print("(calculateFusedPitchAndRoll) Accelerometer Pitch: \(accelerometerData.pitch)")
        print("(calculateFusedPitchAndRoll) Gyroscope Pitch: \(gyroscopeData.pitch)")
        ...
        print("(calculateFusedPitchAndRoll) Fused Roll: \(fusedRoll) degrees")
        print("(calculateFusedPitchAndRoll) Fused Pitch: \(fusedPitch) degrees")
        ...
        print("(calculateFusedPitchAndRoll) Fused Roll in Radians: \(fusedRollRadians)")
        print("(calculateFusedPitchAndRoll) Fused Pitch in Radians: \(fusedPitchRadians)")
        ...
        print("(calculateFusedPitchAndRoll) lengthToJack: \(lengthToJack)")
        print("(calculateFusedPitchAndRoll) width: \(width)")
        ...
        print("(calculateFusedPitchAndRoll) row: \(row)")
        print("(calculateFusedPitchAndRoll) column: \(column)")
        
        
        print("(calculateFusedPitchAndRoll) Device Location: \(data?.deviceLocation)")
...
//        let distanceFromLeftWheel: Double = width - 20 // The distance from the device to the center left wheel in inches
        ...
        print("(calculateFusedPitchAndRoll) tileLength: \(tileLength)")
        print("(calculateFusedPitchAndRoll) tileWidth: \(tileWidth)")
        ...
        print("(calculateFusedPitchAndRoll) distanceFromJack: \(distanceFromJack)")
        ...
        print("(calculateFusedPitchAndRoll) distanceXFromRearWheel: \(distanceXFromRearWheel)")
        print("(calculateFusedPitchAndRoll) distanceYFromRightWheel: \(distanceYFromRightWheel)")
        print("(calculateFusedPitchAndRoll) distanceYFromLeftWheel: \(distanceYFromLeftWheel)")
        ...
        print("(calculateFusedPitchAndRoll) Distance from Jack: \(distanceFromJack) inches")
        print("(calculateFusedPitchAndRoll) Distance from Rear Right Wheel: \(distanceFromRearRightWheel) inches")
        print("(calculateFusedPitchAndRoll) Distance from Left Wheel: \(distanceFromRearLeftWheel) inches")
        ...
        print("(calculateFusedPitchAndRoll) orientation: \(orientation)")
        ...
        print("(calculateFusedPitchAndRoll) height: \(height)")
    ...
    func calculateLevelOffsets(
        ...
        print("Effective Width: \(effectiveWidth) inches")
        switch orientation {
        case .front:
            pitchOffset = distanceFromJack * tan(pitchRadians) // Front-to-Back (interpreted as Pitch)
            rollOffset = width * tan(rollRadians) // Side-to-Side (interpreted as Roll)
        case .rear:
            pitchOffset = -distanceFromJack * tan(pitchRadians) // Front-to-Back (interpreted as Pitch), reversed
            rollOffset = width * tan(rollRadians) // Side-to-Side (interpreted as Roll)
        case .driversSide:
            rollOffset = width * tan(rollRadians) // Side-to-Side (interpreted as Pitch)
